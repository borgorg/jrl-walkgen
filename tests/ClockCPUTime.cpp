...
ClockCPUTime::ClockCPUTime() { Reset(); }
...
void ClockCPUTime::startingDate() { gettimeofday(&m_startingtime, 0); }

void ClockCPUTime::startPlanning() { gettimeofday(&m_begin, 0); }
...
void ClockCPUTime::startModification() { gettimeofday(&m_begin, 0); }
