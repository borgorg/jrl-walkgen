...
class TestMulticontactInverseGeometry : public TestObject {
 ...
 protected:
  int interpolate_support(int it) {
    ...
    MP.clear();
    ToMP.clear();
    TimeInterval = liftCoef * timing_[it];
    iniPos = lfs_[it - 1](0);
    finPos = lfs_[it](0);
    ...
    MP.clear();
    ToMP.clear();
    TimeInterval = gripperCoef * liftCoef * timing_[it];
    iniPos = rhs_[it - 1](0);
    finPos = rhs_[it](0);
    ...
    MP.clear();
    ToMP.clear();
    TimeInterval = gripperCoef * timing_[it];
    iniPos = rhs_[it - 1](2);
    finPos = rhs_[it](2);
    if (finPos - iniPos > epsilon) {
  ...
  int init_support() {
    ...
    // 10cm handrill ////////////////////////// to pass to left hand be
    // carefull!!!!!
