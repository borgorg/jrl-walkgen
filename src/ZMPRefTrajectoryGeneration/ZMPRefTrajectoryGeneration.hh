...
class ZMPRefTrajectoryGeneration : public SimplePlugin {
 ...
 public:
  ...
  inline const double &GetOmega(void) const { return m_Omega; };
  ...
  inline void SetTDoubleSupport(const double &aTdble) { m_Tdble = aTdble; };
  ...
  */
  ...
  void SetCurrentTime(const double &aTime) { m_CurrentTime = aTime; }
