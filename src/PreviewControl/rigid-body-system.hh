...
class RigidBodySystem {
 ...
 public:
  ...
  /// \{
  linear_dynamics_t const &DynamicsCoPJerk() const { return CoPDynamicsJerk_; }
  linear_dynamics_t &DynamicsCoPJerk() { return CoPDynamicsJerk_; }

  inline RigidBody const &CoM() const { return CoM_; };
  inline void CoM(const RigidBody &CoM) { CoM_ = CoM; };

  inline RigidBody const &LeftFoot() const { return LeftFoot_; };
  inline RigidBody &LeftFoot() { return LeftFoot_; };
  inline void LeftFoot(const RigidBody &LeftFoot) { LeftFoot_ = LeftFoot; };

  inline RigidBody const &RightFoot() const { return RightFoot_; };
  inline RigidBody &RightFoot() { return RightFoot_; };
  inline void RightFoot(const RigidBody &RightFoot) { RightFoot_ = RightFoot; };

  inline double SamplingPeriodSim() const { return T_; }
  inline void SamplingPeriodSim(double T) { T_ = T; }

  inline double SamplingPeriodAct() const { return Ta_; }
  inline void SamplingPeriodAct(double Ta) { Ta_ = Ta; }

  inline unsigned NbSamplingsPreviewed() const { return N_; }
  inline void NbSamplingsPreviewed(unsigned N) { N_ = N; }

  inline double Mass() const { return mass_; }
  inline void Mass(double Mass) { mass_ = Mass; }

  inline double CoMHeight() const { return CoMHeight_; }
  inline void CoMHeight(double Height) { CoMHeight_ = Height; }
 ...
 private:
  ...
  linear_dynamics_t CoPDynamicsJerk_;
