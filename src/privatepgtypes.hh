...
enum ineq_e { INEQ_COP, INEQ_COM, INEQ_FEET };

enum objective_e { INSTANT_VELOCITY, COP_CENTERING, JERK_MIN };
...
enum tests_e { NONE, ALL, ITT, CTR };

enum axis_e { X_AXIS, Y_AXIS, Z_AXIS, YAW, PITCH, ROLL };
/// \}
