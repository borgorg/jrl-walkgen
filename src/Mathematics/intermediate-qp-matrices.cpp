...
IntermedQPMat::objective_variant_t const &IntermedQPMat::Objective(
    objective_e type) const {
  switch (type) {
...
void IntermedQPMat::dump_objective(const char *filename, objective_e type) {
  std::ofstream aof;
